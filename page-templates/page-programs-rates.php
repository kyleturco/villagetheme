  ...
  <div id="programs-subnav">
    <div class="container">
      <ul class="list-inline text-center">
        <li><a href="#class-1">Preschool 2</a></li>
        <li><a href="#class-2">Preschool 3</a></li>
        <li><a href="#class-3">Pre-Kindergarten</a></li>
        <li><a href="#class-4">Parent-Infant-Toddler</a></li>
      </ul>
    </div>
  </div>
